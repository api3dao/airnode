...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var integrationInfo, integrationPath, secretsFilePath, deployCommand;
    return __generator(this, function (_a) {
        integrationInfo = (0, src_1.readIntegrationInfo)();
        if (integrationInfo.airnodeType !== 'aws') {
            src_1.cliPrint.error('You only need to run this script if you deploy on AWS');
            return [2 /*return*/];
        }
        integrationPath = (0, path_1.join)(__dirname, '../integrations', integrationInfo.integration);
        secretsFilePath = (0, path_1.join)(__dirname, '../aws.env');
        deployCommand = [
            "docker run -it --rm",
...
//# sourceMappingURL=remove-airnode.js.map

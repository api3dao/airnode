...
If you would like to know more about RRP, read the [API3 docs](https://docs.api3.org/airnode/v1.0/concepts/).
...
The [RRP contract](https://docs.api3.org/airnode/v1.0/concepts/#airnoderrp-sol) is a contract through which the
[requester](https://docs.api3.org/airnode/v1.0/concepts/requester.html) triggers a request for Airnode. This contract is
...
Refer to the
[documentation](https://docs.api3.org/airnode/v1.0/grp-providers/guides/build-an-airnode/configuring-airnode.html) for
more details.
...
Airnode request requires a [sponsor](https://docs.api3.org/airnode/v1.0/concepts/sponsor.html), which will pay for the
...
[documentation](https://docs.api3.org/airnode/v1.0/grp-developers/requesters-sponsors.html#how-to-derive-a-sponsor-wallet)
for more details.

...
describe('constants', () => {
  it('returns constant values', () => {
    ...
    expect(constants.API_CALL_TIMEOUT).toEqual(60_000);
    expect(constants.API_CALL_TOTAL_TIMEOUT).toEqual(60_000);
    ...
    expect(constants.EVM_PROVIDER_TIMEOUT).toEqual(60_000);
    expect(constants.WORKER_CALL_API_TIMEOUT).toEqual(60_000);
    expect(constants.WORKER_PROVIDER_INITIALIZATION_TIMEOUT).toEqual(60_000);
    expect(constants.WORKER_PROVIDER_PROCESS_REQUESTS_TIMEOUT).toEqual(60_000);
  });
});

...
export const API_CALL_TOTAL_TIMEOUT = 60_000;

// The maximum time an API call has before it is timed out (and retried).
export const API_CALL_TIMEOUT = 60_000;

...
if (args.template) {
  log(JSON.stringify(convert(args.specification, args.template, args.secrets), null, 2));
  process.exit();
}

log(JSON.stringify(convertWithTemplate(args.specification, args.from, args.to, args.secrets), null, 2));

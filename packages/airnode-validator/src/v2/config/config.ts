...
export const cloudProviderSchema = z.union([awsCloudProviderSchema, gcpCloudProviderSchema]);
...
export const adapterApiCredentialsSchema = z.object({
  securitySchemeName: z.string(),
  securitySchemeValue: z.string(),
});

export const apiCredentialsSchema = adapterApiCredentialsSchema.extend({
  oisTitle: z.string(),
});

...
should be used in validation, it can be appended to template argument (validator will ignore patch version):

```sh
yarn run validate --template="config@0.2" --specs="exampleSpecs/config.specs.json"
```

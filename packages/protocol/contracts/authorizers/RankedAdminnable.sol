...
contract RankedAdminnable is IRankedAdminnable {
  mapping(bytes32 => mapping(address => uint256)) private adminnedIdToAdminToRank;
  ...
  function getRank(bytes32 adminnedId, address admin) public view virtual override returns (uint256) {

...
contract RequesterStore is IRequesterStore {
  mapping(address => mapping(address => bool)) public requesterToClientAddressToEndorsementStatus;
  ...
  function setClientEndorsementStatus(address clientAddress, bool endorsementStatus) external override {
    ...
    requesterToClientAddressToEndorsementStatus[msg.sender][clientAddress] = endorsementStatus;
    emit ClientEndorsementStatusSet(msg.sender, clientAddress, endorsementStatus);
  }
}

    ...
    IAirnodeTokenPaymentRolesWithManager
{
    ...
    //     ├── (3) Airnode to minimum whitelist duration setter
    ...
    string
        public constant
        override AIRNODE_TO_MINIMUM_WHITELIST_DURATION_SETTER_ROLE_DESCRIPTION =
        "Airnode to minimum whitelist duration setter";
    string
        public constant
    ...
    bytes32
        internal constant AIRNODE_TO_MINIMUM_WHITELIST_DURATION_SETTER_ROLE_DESCRIPTION_HASH =
        keccak256(
            abi.encodePacked(
                AIRNODE_TO_MINIMUM_WHITELIST_DURATION_SETTER_ROLE_DESCRIPTION
            )
        );
    bytes32
    ...
    bytes32
        public immutable
        override airnodeToMinimumWhitelistDurationSetterRole;
    ...
    constructor(
        ...
        airnodeToMinimumWhitelistDurationSetterRole = _deriveAirnodeToMinimumWhitelistDurationSetterRole(
            _manager
        );
    ...
    /// @notice Derives the Airnode to minimum whitelist duration setter role
    /// for the specific manager address
    /// @param _manager Manager address
    /// @return _airnodeToMinimumWhitelistDurationSetterRole Airnode to whitelist
    /// duration setter role
    function _deriveAirnodeToMinimumWhitelistDurationSetterRole(
        address _manager
    )
        internal
        view
        returns (bytes32 _airnodeToMinimumWhitelistDurationSetterRole)
    {
        _airnodeToMinimumWhitelistDurationSetterRole = _deriveRole(
            _deriveAdminRole(_manager),
            AIRNODE_TO_MINIMUM_WHITELIST_DURATION_SETTER_ROLE_DESCRIPTION_HASH
        );
    }
    ...
    /// @dev Returns if the account has the Airnode to minimum whitelist
    /// duration setter role or is the manager
    /// @param account Account address
    /// @return If the account has the Airnode to minimum whitelist duration
    /// setter or is the manager
    function hasAirnodeToMinimumWhitelistDurationSetterRoleOrIsManager(
        address account

...
describe('encodeValue', () => {
  ...
  describe('encoding array values', () => {
    it('one dimensional array', () => {
      ...
      expect(encoding.encodeValue(array, 'int256[]')).toEqual(
      ...
      expect(encoding.encodeValue(array, 'int256[2]')).toEqual(
    ...
    it('mixed fixes/unlimited array', () => {
      ...
      expect(encoding.encodeValue(array, 'int256[2][][3]')).toEqual(
  ...
  it('throws on invalid encoding type', () => {
    expect(() => encoding.encodeValue('', 'unit256')).toThrow(`Unknown type: unit256`);
    expect(() => encoding.encodeValue('', 'int256[[]]')).toThrow(`Unknown type: int256[[]]`);
    expect(() => encoding.encodeValue('', '[int256]')).toThrow(`Unknown type: [int256]`);
  });
});

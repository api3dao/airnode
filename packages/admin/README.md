...
Derives the address of the wallet designated by an Airnode for a sponsor, which is called the sponsor wallet. The
`airnode-xpub` must belong to the HDNode with the path `m/44'/60'/0'` of the Airnode wallet.

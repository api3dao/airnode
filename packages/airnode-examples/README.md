...
- [CoinGecko signed relayed data](https://github.com/api3dao/airnode/tree/master/packages/airnode-examples/integrations/coingecko-signed-data) -
  same price request as the CoinGecko example above. However, the endpoint can be used to retrieve signed relayed data.
